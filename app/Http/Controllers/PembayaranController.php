...
class PembayaranController extends Controller
{
    ...
    {
        $total_bayar = Pembayaran::where('siswa_id', $siswa_id)->sum('jumlah_bayar');
        $sisa_bayar = 480000 - $total_bayar;
        $pembayaran = Pembayaran::where('siswa_id', $siswa_id)->paginate(5);
        return view('pembayaran.history', compact('pembayaran','total_bayar','sisa_bayar'));
    }
